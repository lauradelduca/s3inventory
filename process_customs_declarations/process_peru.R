## Preprocessing of Peru customs declarations trade data 2013 - 2015 from SICEX2.5, 2016 - 2017 from SICEX2.0, 2012 from 'SOURCE'
## Laura Del Duca
...
put_object(	file = rawConnectionValue(zz), 
			bucket = 'trase-storage', 
			object = paste0('data/1-TRADE/CD/EXPORT/PERU/', yy, '/SOURCE/TEST/CD_PERU_', yy, '.csv') )
# close the connection
close(zz)
